...
function vue360(id, n, p, t, playable, autoPlay, draggable, mouseMove, buttons, keys, scroll) {
    ...
    if (!playable && !autoPlay) {
        ...
        function nonTouch() {
            ...
            function mouseEvent() {
                img.addEventListener('mousemove', function (e) {console.log('mv');
            ...
            if (scroll) {
                img.addEventListener('wheel', function (e) {
                    e.preventDefault();
                    (e.wheelDelta / 120 > 0) ? prev(this) : nxt(this);
                });
            }
            if (keys) {
